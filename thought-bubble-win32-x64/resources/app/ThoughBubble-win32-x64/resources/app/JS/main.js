  ...
  //  sound:undefined,
    ...
    init: function(){
       ...
       // this.bg.src = 'media/bg.png';
        ...
        //initalization
         ...
         this.canvas.onmousemove = this.doMove.bind(this);
    ...
    doZoom: function(e){
     /*   var delta = Math.max(-1, Math.min(1,(e.wheelDelta || -e.detail)));
        this.scale = this.scale + (delta/40);
        if(this.scale<=0){
            this.scale = 0;
        }

        this.translation.x = this.canvas.width/2;
        this.translation.y = this.canvas.width/2;*/
       ...
       /*this.ctx.translate(this.WIDTH/2, this.HEIGHT/2)
        ...
        this.ctx.translate(-this.WIDTH/2,-this.HEIGHT/2)*/
          ...
          //  var mousex = (e.clientX - this.canvas.offsetLeft) - this.translation.x;
            //var mousey = (e.clientY - this.canvas.offsetTop) - this.translation.y;
            
      
     /*   this.mouse = getMouse(e);
         var mousex = (this.mouse.x- this.translation.x) / this.scale;
         var mousey =(this.mouse.y - this.translation.y) / this.scale;*/
            var wheel = e.wheelDelta/120;
            var zoom = Math.exp(wheel*0.02);
       
      /*  this.ctx.translate(-this.translation.x, -this.translation.y);*/
           //   var pScale = this.scale;
              this.scale *= zoom;

        //Maintains max and min scaling factor
          if(this.scale <= 0.5){
              this.scale = 0.5
          }
        ...
        //finds new translation
        //  this.translation.x -=mousex/(this.scale)- mousex/pScale;
          //  this.translation.y -=mousey/(this.scale)-mousey/pScale;
